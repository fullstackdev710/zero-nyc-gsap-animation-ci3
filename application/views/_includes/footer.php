   ...
   <div class="office-snapshots media-within" data-entrance="stagger-fade" data-offset=".86" data-offset-mobile=".85">
      <div class="office parallax-hover s-el" data-out="fade">
         ...
         <address class="address move-el">
            <h3><a href="javascript:void(0);" class="modal-trigger" data-modal="mark-goldwell" aria-label="Read Bio">40+
               </a></h3>
            <p>Companies Built</p>
         </address>
      </div>
      <div class="office parallax-hover s-el" data-out="fade">
         ...
         <address class="address move-el">
            <h3><a href="javascript:void(0);" class="modal-trigger" data-modal="joseph-f.-delaney-iii" aria-label="Read Bio">6+
               </a></h3>
            <p>Portfolio Exits</p>
         </address>
      </div>
      <div class="office parallax-hover s-el" data-out="fade">
         ...
         <address class="address move-el">
            <h3><a href="javascript:void(0);" class="modal-trigger" data-modal="chelsea-goldwell" aria-label="Read Bio">130+
               </a></h3>
...
<div class="canvas-wrapper basketball" aria-hidden="true"></div>

<div class="pencil-bar">
   <div class="copy-wrapper desktop">
      <p>Welcome to the <a target="_blank" rel="noopener" href="https://chomps.com/">Meataverse</a> - New launch for Chomps 🍖</p>
   </div>

   <div class="copy-wrapper mobile">
      <p>New <a target="_blank" rel="noopener" href="https://chomps.com/">Chomps Site</a> by Zero 🍖</p>
   </div>
...
<div class="ballin-wrapper state-1" tabindex="-1">
   <div class="bg" style="background-color: #e37200;"></div>
...
<div class="ballin-wrapper state-2" tabindex="-1">
   <div class="bg" style="background-color: #e30000;"></div>
