   ...
   <div class="view-work-type" data-router-view="work-type" data-transition-in="default">
      <section>
         <div class="hero" data-out="fade">
            <img class="bg miq" alt="" src="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-1.png" style="opacity: 1;">
         </div>
         ...
         <div class="full-bleed c-60 media-within">
            <div class="image-wrapper" style="--dar: 62.5%; opacity: 0; transform: translate(0px, 20px);" data-out="fade" data-entrance="basic-fade" data-offset=".86" data-offset-mobile=".85">
               <img class="bg preload" data-preload-desktop="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-1.png" data-preload-mobile="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-1.png" alt="">
            </div>
         </div>
         ...
         <div class="full-bleed c-60 media-within">
            <div class="image-wrapper" style="--dar: 52.7778%; opacity: 0; transform: translate(0px, 20px);" data-out="fade" data-entrance="basic-fade" data-offset=".86" data-offset-mobile=".85">
               <img class="bg preload" data-preload-desktop="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-2.png" data-preload-mobile="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-2.png" alt="">
            </div>
         </div>
         ...
         <div class="full-bleed c-60 media-within">
            <div class="image-wrapper" style="--dar: 87.2222%; opacity: 0; transform: translate(0px, 20px);" data-out="fade" data-entrance="basic-fade" data-offset=".86" data-offset-mobile=".85">
               <img class="bg preload" data-preload-desktop="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-3.png" data-preload-mobile="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-3.png" alt="">
            </div>
         </div>

         <div class="full-bleed c-60 media-within">
            <div class="image-wrapper" style="--dar: 87.2222%; opacity: 0; transform: translate(0px, 20px);" data-out="fade" data-entrance="basic-fade" data-offset=".86" data-offset-mobile=".85">
               <img class="bg preload" data-preload-desktop="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-4.png" data-preload-mobile="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-4.png" alt="">
            </div>
         </div>
