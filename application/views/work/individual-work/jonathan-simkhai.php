   ...
   <div class="view-work-type" data-router-view="work-type" data-transition-in="default">
      <section>
         <div class="hero" data-out="fade">
            <img class="bg miq" alt="" src="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-1.webp" style="opacity: 1;">
         </div>
         ...
         <div class="work-intro c-120" data-out="fade" data-entrance="basic-fade" data-offset=".65" data-offset-mobile=".85" style="opacity: 1;">
            ...
            <div class="subcopy">
               ...
               <p><strong>Client:</strong> Jonathan Simkhai</p>
         ...
         <div class="full-bleed c-60 media-within">
            <div class="image-wrapper" style="--dar: 62.5%; opacity: 0; transform: translate(0px, 20px);" data-out="fade" data-entrance="basic-fade" data-offset=".86" data-offset-mobile=".85">
               <img class="bg preload" data-preload-desktop="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-1.webp" data-preload-mobile="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-1.webp" alt="">
            </div>
         </div>
         ...
         <div class="full-bleed c-60 media-within">
            <div class="image-wrapper" style="--dar: 52.7778%; opacity: 0; transform: translate(0px, 20px);" data-out="fade" data-entrance="basic-fade" data-offset=".86" data-offset-mobile=".85">
               <img class="bg preload" data-preload-desktop="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-2.webp" data-preload-mobile="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-2.webp" alt="">
            </div>
         </div>
         ...
         <div class="full-bleed c-60 media-within">
            <div class="image-wrapper" style="--dar: 87.2222%; opacity: 0; transform: translate(0px, 20px);" data-out="fade" data-entrance="basic-fade" data-offset=".86" data-offset-mobile=".85">
               <img class="bg preload" data-preload-desktop="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-3.webp" data-preload-mobile="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-3.webp" alt="">
            </div>
         </div>

         <div class="full-bleed c-60 media-within">
            <div class="image-wrapper" style="--dar: 87.2222%; opacity: 0; transform: translate(0px, 20px);" data-out="fade" data-entrance="basic-fade" data-offset=".86" data-offset-mobile=".85">
               <img class="bg preload" data-preload-desktop="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-4.webp" data-preload-mobile="<?php echo base_url(); ?>/assets/img/jonathan-simkhai/Jonathan-Simkhai-4.webp" alt="">
            </div>
         </div>
         ...
         <div class="full-text">
            <div class="c-120">
               <div class="inner" data-out="fade" data-entrance="basic-fade" data-offset=".65" data-offset-mobile=".85" style="opacity: 0; transform: translate(0px, 20px);">
                  ...
                  <p>Established in 2010, the Jonathan Simkhai brand provides luxury ready-to-wear for the modern woman. onathan Simkhai is debuting Standard, a capsule of low-impact essentials like T-shirts, jeans, and knits that will be a “stepping stone” toward better Through designs that seek to embolden women with confidence and ease, the brand represents modern versatility.</p>
               </div>
            </div>
         </div>
